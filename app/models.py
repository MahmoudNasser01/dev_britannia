...
class ExamResult(models.Model):
    ...
    grammar_total = models.DecimalField(max_digits=5, decimal_places=2,default=40)
    vocabulary = models.DecimalField(max_digits=5, decimal_places=2,)
    vocabulary_total = models.DecimalField(max_digits=5, decimal_places=2,default=20)
    reading = models.DecimalField(max_digits=5, decimal_places=2,)
    reading_total = models.DecimalField(max_digits=5, decimal_places=2,default=20)
    writing = models.DecimalField(max_digits=5, decimal_places=2,)
    writing_total = models.DecimalField(max_digits=5, decimal_places=2,default=20)
    listening = models.DecimalField(max_digits=5, decimal_places=2,)
    listening_total = models.DecimalField(max_digits=5, decimal_places=2,default=20)
    speaking = models.DecimalField(max_digits=5, decimal_places=2,)
    speaking_total = models.DecimalField(max_digits=5, decimal_places=2,default=20)
    teacher_assessment = models.DecimalField(max_digits=5, decimal_places=2,)
    teacher_assessment_total = models.DecimalField(max_digits=5, decimal_places=2,default=10)

    # Calculated fields
    total_score = models.DecimalField(max_digits=5, decimal_places=2,null=True, blank=True)
    total_score_out_of = models.DecimalField(max_digits=5, decimal_places=2,default=150)
